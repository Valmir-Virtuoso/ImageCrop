...
let startX, endX, startY, endY, relativeStartX, relativeEndX, relativeStartY, relativeEndY;
...
//Cortar a imagem
const cropButton = document.getElementById('crop-imagem')
...
cropButton.onclick = () =>{
    ...
    //pegar to contexto a imagem cortada
    ...
    //adicionar a imagem croppada ao contexto do canvas
